...
// NekoSam
/obj/item/clothing/suit/roguetown/armor/longcoat/wyrd_cloak // There is no armor. This is the one way to make the sprite work without making it a robe which we got told no. - Steiner
