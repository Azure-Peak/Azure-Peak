...
/obj/item/rogueweapon/greatsword/zhanmadao
	...
	alt_grips = null // can't be alt-gripped
	name = "Zhanmadao"
	desc = "A traditional Lingyuese weapon, the 'horse chopping saber', first pioneered during the Yuanzhao dynasty to counter cut through saigas and fogbeasts legs from below. It consists of a long, single-edged blade affixed to a hilt meant strictly for two-handed use, and is designed strictly for cutting and wide sweeping attacks. Quite bad at thrusting, unusable for striking."
