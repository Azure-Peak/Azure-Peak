/datum/advclass/assassin_poisoner
	...
	traits_applied = list(TRAIT_NOSTINK, TRAIT_ALCHEMY_EXPERT, TRAIT_UNCONVERTABLE)	// Stinky Man - You get tossed a bone around rotting corpses. Plays into the poison and stuff.
	// Weighted 14
	subclass_stats = list(
		STATKEY_PER = 1,
		STATKEY_SPD = 3,
