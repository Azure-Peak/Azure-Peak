/datum/advclass/heretic/ancient_deathknight
	...
	outfit = /datum/outfit/job/roguetown/heretic/ancient_deathknight
...
/datum/outfit/job/roguetown/heretic/ancient_deathknight/pre_equip(mob/living/carbon/human/H)
	..()
