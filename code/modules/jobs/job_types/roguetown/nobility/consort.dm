...
//		SSticker.rulermob = H
	...
	if(H.mind)
		...
		H.verbs |= /mob/living/carbon/human/proc/grant_title_verb
		H.verbs |= /mob/living/carbon/human/proc/grant_nobility_verb
		H.verbs |= /mob/living/carbon/human/proc/recruit_servant_verb
