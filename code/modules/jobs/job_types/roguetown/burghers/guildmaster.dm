/datum/job/roguetown/guildmaster
	...
	job_traits = list(TRAIT_TRAINED_SMITH, TRAIT_SEEPRICES, TRAIT_SMITHING_EXPERT, TRAIT_SEWING_EXPERT, TRAIT_HOMESTEAD_EXPERT, TRAIT_DEVOUT_FOLLOWER, TRAIT_TENNITE_TOWN)
