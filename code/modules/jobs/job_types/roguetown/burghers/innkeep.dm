/datum/job/roguetown/innkeeper
	...
	job_traits = list(TRAIT_MEDIUMARMOR, TRAIT_TAVERN_FIGHTER, TRAIT_EMPATH, TRAIT_DODGEEXPERT, TRAIT_CICERONE, TRAIT_HOMESTEAD_EXPERT, TRAIT_DEVOUT_FOLLOWER, TRAIT_TENNITE_TOWN)
