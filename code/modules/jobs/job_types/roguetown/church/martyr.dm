...
/datum/job/roguetown/martyr
	...
	virtue_restrictions = list(/datum/virtue/combat/pallid, /datum/virtue/utility/noble, /datum/virtue/combat/rotcured, /datum/virtue/utility/hollow, /datum/virtue/combat/dualwielder, /datum/virtue/heretic/zchurch_keyholder)
