/datum/advclass/templar/guardian
	name = "Guardian"
	tutorial = "You are a guardian of the Church, trained in heavy weaponry and zealous warfare. You are the instrument of your God's wrath, clad in steel and faith."
	outfit = /datum/outfit/job/roguetown/templar/guardian
	category_tags = list(CTAG_TEMPLAR)

	maximum_possible_slots = 1 // The other snowflake
