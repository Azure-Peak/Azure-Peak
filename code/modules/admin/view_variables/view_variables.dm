...
/client/proc/debug_variables_verb(datum/D in world)
...
/client/proc/debug_variables(datum/thing)
	var/static/vv_css = file2text('html/admin/view_variables.css')
	...
	var/dark_mode = usr.client.prefs?.vv_dark_mode // I guess use the admin's pref??
...
<html>
	...
	<body [dark_mode ? "class=\"theme-dark\"" : ""] onload='selectTextField()' onkeydown='return handle_keydown()' onkeyup='handle_keyup()'>
