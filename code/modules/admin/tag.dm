...
#define TAG_SIMPLE_HEALTH(X) "<font color='#ff0000'><b>Health: UNK (RT)</b></font>"
#define TAG_CARBON_HEALTH(X) TAG_SIMPLE_HEALTH(X)
...
/client/proc/display_tags()
	...
	set name = "Tagged Datums"
	set desc = "Display all of your tagged datums."
