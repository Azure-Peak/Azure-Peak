...
/datum/round_event/skellysiege/start()
	SSmapping.add_world_trait(/datum/world_trait/skeleton_siege, rand(12 MINUTES, 16 MINUTES)) //Larger Varience + More time, these guys literally will fold over to just about anything. So they need to keep spawning in to cause problems.
