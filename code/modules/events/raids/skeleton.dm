...
/datum/round_event/worldsiege/start()
	SSmapping.add_world_trait(/datum/world_trait/skeleton_siege, rand(12 MINUTES, 20 MINUTES)) //Larger Varience + More time, these guys literally will fold over to just about anything.
