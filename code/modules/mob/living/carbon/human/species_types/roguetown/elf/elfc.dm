...
/datum/species/elf/sun
	...
	slaver state, with most members requiring to earn their right to the lands' Xylixian freedom. \
	The past half-century has seen an eruption of religious warfare, \
