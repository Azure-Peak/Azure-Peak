...
/datum/species/dullahan
	...
	inherent_traits = list(TRAIT_EASYDECAPITATION, TRAIT_NOHUNGER, TRAIT_NOBREATH, TRAIT_DEATHLESS, TRAIT_ZOMBIE_IMMUNE, TRAIT_UNHOLY_LYFE) //Given the deathless traits inherently as part of their nature as pseudo-undead.
	use_skintones = TRUE
	disliked_food = NONE
	liked_food = NONE
