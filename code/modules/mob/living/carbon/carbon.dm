...
/mob/living/carbon/resist_fire()
	...
	adjust_fire_stacks(-1, /datum/status_effect/fire_handler/fire_stacks/vheslyn)
	...
	if(fire_status?.stacks + sunder_status?.stacks + divine_status?.stacks + vheslyn_status?.stacks + blessed_sunder?.stacks > 10 || !(mobility_flags & MOBILITY_STAND))
