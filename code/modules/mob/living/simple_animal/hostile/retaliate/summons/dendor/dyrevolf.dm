...
/mob/living/simple_animal/hostile/retaliate/rogue/dyrevolf/fire/ability(turf/target_location, mob/living/user)
	...
	return TRUE
/*
/mob/living/simple_animal/hostile/retaliate/rogue/dyrevolf/water
...
/mob/living/simple_animal/hostile/retaliate/rogue/dyrevolf/water/ability(turf/target_location, mob/living/user)
	if(world.time < src.next_ability_use)
		to_chat(user, "[src] is not yet ready to use its special ability.")
		return FALSE
	if(!do_after(src,1 SECONDS, src))
...
/mob/living/simple_animal/hostile/retaliate/rogue/dyrevolf/air
	name = "air primordial"
...
/mob/living/simple_animal/hostile/retaliate/rogue/dyrevolf/air/proc/knockback(mob/living/L, dir, distance)
	if(!L || !isturf(L.loc))
		return
