...
/datum/virtue/origin/unselectable/skeleton
	...
	origin_desc = "In Psydonia there were are many, many great empires that once stood the test of aeon's grip; most notably there was the Holy Celestrial Empyre, \
