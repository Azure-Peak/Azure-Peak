...
/datum/virtue/combat/second_chance
	...
	choice_tooltips = list(
		...
		SC_BLACKBLOOD = "<font color='#8b488d'>I was once a nite-creacher, be it lycanthrope or vampyre, before the Otavan Inquisition subdued and exported me as a test subject of an experimental \"cure\" for my taint. This intense therapy had me warped, inside, outside, body and mind, into something 'idealistically' humen-like for Otavan standards, even if I am now no different than a sentient, hollowed ghoul.<br><br><font color=red>(Grants Darkvision, Deathless, Strong Bite, Inhumen Digestion, and Silver Weakness.)<br><br><font color=white>(Additionally, healing miracles do not work on you, but consuming any food will grant a minor healing buff. You will feel stressed when exposed to Sunlight, and panic while being around members of the Inquisition.)",
	)
