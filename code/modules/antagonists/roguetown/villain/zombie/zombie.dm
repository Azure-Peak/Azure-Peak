...
/atom/movable/screen/alert/status_effect/debuff/deadite_grace
	...
	desc = "My corroded Lux is ravaging throughout my decaying corpse, although I cannot sprint during this, I cannot be stopped either, not while this lasts."
...
/datum/status_effect/debuff/deadite_grace/on_apply()
	...
	ADD_TRAIT(owner, TRAIT_NORUN, id) //Lets not have invulnerable slowdown-immune sprinters. You get a window to escape the NPC dorpel until you attack.
...
/datum/status_effect/debuff/deadite_grace/on_remove()
	...
	var/mob/living/carbon/human/H = owner
	H.status_flags -= GODMODE
	REMOVE_TRAIT(owner, TRAIT_NORUN, id) //Okay we're not immortal anymore, go forth. Sprint and frag my childe. Break their kneecaps.
