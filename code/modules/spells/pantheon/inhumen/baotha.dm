...
/obj/effect/proc_holder/spell/invoked/projectile/magic/blowingdust/cast(list/targets, mob/user = user)
	var/mob/living/carbon/human/H = user
	var/datum/rmb_intent/rmb_intent = H.rmb_intent // Use the primary intent of the user.
	switch(H.rmb_intent.name)
		if("feint")
