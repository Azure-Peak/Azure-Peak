...
/datum/action/cooldown/spell/miracle/heal/cast(atom/cast_on)
	...
	if(HAS_TRAIT(spelltarget, TRAIT_BLACKBLOOD))
		spelltarget.visible_message(span_info("[spelltarget] stirs in pain, the miracle dissipates."), span_blue("You feel a dull pain spreading through your body, only to fade as quickly as it arrived."))
		owner.playsound_local(owner, 'sound/magic/PSY.ogg', 100, FALSE, -1)
		playsound(spelltarget, 'sound/magic/PSY.ogg', 100, FALSE, -1)
