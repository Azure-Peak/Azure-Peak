...
/obj/effect/proc_holder/spell/invoked/xylixslip
	name = "Xylix Slip"
...
/obj/effect/proc_holder/spell/invoked/xylixslip/proc/reset(silent = FALSE)
...
/obj/effect/proc_holder/spell/invoked/xylixslip/proc/check_path(turf/Tu, turf/Tt)
...
/obj/effect/proc_holder/spell/invoked/xylixslip/proc/tp(mob/user)
	if(destination_turf)
...
/obj/effect/proc_holder/spell/invoked/xylixslip/cast(list/targets, mob/user)
...
/obj/effect/proc_holder/spell/invoked/xylixslip/proc/lockon(turf/T, mob/user)
	if(user.m_intent == MOVE_INTENT_SNEAK)
...
/atom/movable/screen/alert/status_effect/boon
	name = "Xylix's Boon"
	desc = "The scales feel tipped in my favor! How lucky. (Having a coin/dice in one hand and then having an empty hand selected allows you to right click and rig the outcome)"
	icon_state = "joy"
