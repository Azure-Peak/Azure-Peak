...
<p><b>The Burgher Pledge</b> is not coin, but <i>authority</i> - a token of the Realm's standing to commission military action. It is granted daily in fixed measure, and only while the Golden Bull of Kingsfield stands in force. Should the Bull be suspended, the Burghers withdraw their contribution to the common defense, and the Pledge shall not replenish until the Bull is restored.</p>
