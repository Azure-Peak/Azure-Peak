/datum/decree/zenistadt_concordat
	id = DECREE_ZENISTADT_CONCORDAT
	name = "The Zenistadt Concordat"
...
/datum/decree/zenistadt_concordat/apply_exemption(mob/living/payer, tax_category)
	if(!active)
		return FALSE
