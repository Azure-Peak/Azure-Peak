...
/datum/supply_pack/rogue/grenzelhoft/seax
	...
	cost = 70
	contains = list(/obj/item/rogueweapon/huntingknife/combat/fencerguy)
	ship_qty_min = 1
	ship_qty_max = 2
...
/datum/supply_pack/rogue/grenzelhoft/merc_tabard
	...
	cost = 70
	contains = list(/obj/item/clothing/cloak/tabard/stabard/grenzelhoft)
	ship_qty_min = 1
	ship_qty_max = 3

/datum/supply_pack/rogue/grenzelhoft/magos_mantle
	name = "Celestial Magos Mantle"
	cost = 80
	contains = list(/obj/item/clothing/cloak/tabard/stabard/grenzelmage)
	ship_qty_min = 1
	ship_qty_max = 2
...
/datum/supply_pack/rogue/grenzelhoft/heavy_bolts
	...
	cost = 60
	contains = list(/obj/item/quiver/bolt/heavy/standard)
	ship_qty_min = 1
	ship_qty_max = 3
