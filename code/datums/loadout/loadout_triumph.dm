...
/datum/loadout_item/rosadress
	name = "Ivory Dress"
	path = /obj/item/clothing/suit/roguetown/shirt/tunic/rosa
	triumph_cost = 3
	sort_category = "Triumphs"

/datum/loadout_item/rosadresstwo
	name = "Scarlet Dress"
	path = /obj/item/clothing/suit/roguetown/shirt/tunic/rosa/two
	triumph_cost = 3
	sort_category = "Triumphs"

/datum/loadout_item/rosadressthree
	name = "Velvet Dress"
	path = /obj/item/clothing/suit/roguetown/shirt/tunic/rosa/three
	triumph_cost = 3
	sort_category = "Triumphs"

/datum/loadout_item/rosadressfour
	name = "Obsidian Dress"
	path = /obj/item/clothing/suit/roguetown/shirt/tunic/rosa/four
	triumph_cost = 3
	sort_category = "Triumphs"

/datum/loadout_item/rosadressfive
	name = "Sable Dress"
	path = /obj/item/clothing/suit/roguetown/shirt/tunic/rosa/five
	triumph_cost = 3
	sort_category = "Triumphs"

/datum/loadout_item/rosadresssix
	name = "Maroon Dress"
	path = /obj/item/clothing/suit/roguetown/shirt/tunic/rosa/six
	triumph_cost = 3
	sort_category = "Triumphs"

/datum/loadout_item/rosacoat
	name = "Regal Coat"
	path = /obj/item/clothing/suit/roguetown/armor/longcoat/rosa
	triumph_cost = 3
	sort_category = "Triumphs"

/datum/loadout_item/rosacoattwo
	name = "Courtly Coat"
	path = /obj/item/clothing/suit/roguetown/armor/longcoat/rosa/two
	triumph_cost = 3
	sort_category = "Triumphs"

/datum/loadout_item/rosacoatthree
	name = "Royal Coat"
	path = /obj/item/clothing/suit/roguetown/armor/longcoat/rosa/three
	triumph_cost = 3
	sort_category = "Triumphs"

/datum/loadout_item/rosacoatfour
	name = "Stately Coat"
	path = /obj/item/clothing/suit/roguetown/armor/longcoat/rosa/four
	triumph_cost = 3
	sort_category = "Triumphs"
