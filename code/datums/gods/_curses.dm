...
/datum/curse/proc/on_gain(mob/living/carbon/human/owner, curse_resist = FALSE)
	...
	owner.playsound_local(owner, 'sound/misc/excomm.ogg', 80, FALSE, pressure_affected = FALSE)
	return
...
/datum/curse/proc/on_loss(mob/living/carbon/human/owner, curse_resist = FALSE)
	...
	owner.playsound_local(owner, 'sound/misc/bell.ogg', 80, FALSE, pressure_affected = FALSE)
	qdel(src)
	return
