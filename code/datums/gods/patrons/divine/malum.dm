/datum/patron/divine/malum
	...
	miracles = list(/obj/effect/proc_holder/spell/targeted/touch/orison			= CLERIC_ORI,
					/obj/effect/proc_holder/spell/invoked/rework                = CLERIC_T0,
					/obj/effect/proc_holder/spell/self/repair                   = CLERIC_T0,
...
/datum/patron/divine/malum/on_lesser_heal(
	...
	*message_self = span_info("I feel the heat of a forge soothing my pains!")
	...
	var/list/firey_stuff = list(/obj/machinery/light/rogue/torchholder, /obj/machinery/light/rogue/campfire, /obj/machinery/light/rogue/hearth, /obj/machinery/light/rogue, /obj/machinery/light/rogue/candle, /obj/machinery/light/rogue/forge)
	var/bonus = 0
