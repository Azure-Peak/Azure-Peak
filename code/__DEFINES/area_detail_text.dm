...
#define DETAIL_TEXT_MENAGERIE "A tomb with open doors and a welcoming entrance. Its owners are long gone, yet something within still calls forth. Those who heed the summons gather here willingly, only to find themselves trapped, added to an ever-growing collection."
#define DETAIL_TEXT_DRONINGDEEP "The depths of the dungeon are littered with old bones. The air is uncomfortably humid, and the very walls rattle with the steps of the dead. Reality groans. Madness swells."
