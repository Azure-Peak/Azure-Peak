...
#define TRAIT_BOOTSHINE "Polishing Expert"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_BOOTSHINE = span_info("With a fine brush and polishing cream at hand, I know how to polish equipment until it shines!"),
