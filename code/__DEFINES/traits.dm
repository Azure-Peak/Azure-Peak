...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_UNFORGIVABLE = span_narsie("I AM IRREDEEMABLY CORRUPTED BEYOND FORGIVENESS, THE NEEDLE IN MY EYE OPENS MY MYND TO THE TRUTH! HELL IS REAL AND I AM HOLDING THE TORCH TO BURN THE GARDEN, ALL WHOM ATTEMPT TO DIVERGE ME FROM THIS PATH TO BE UNMADE SHALL JOIN ME."),
