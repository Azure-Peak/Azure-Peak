...
#define TRAIT_BOGLEVY "Terrorbog Levyman"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_BOGLEVY = span_info("I am a member of the Bog levy. In the Terrorbogs, my abilities are sharper from my familiarity."),
