...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_UNFORGIVABLE = span_narsiesmall("THE NEEDLE IN MY EYE OPENS MY MYND TO THE TRUTH! HELL IS REAL, THE GARDEN IS ON FIRE, REALITY IS SUFFERING AND I AM HOLDING THE TORCH TO BURN THE GARDEN, ALL WHOM ATTEMPT TO DIVERGE ME FROM THIS PATH TO BE UNMADE SHALL JOIN ME."),
