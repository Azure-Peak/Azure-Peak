...
#define TRAIT_LEYLINES "Leyline's Clarity"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_LEYLINE = span_warning("I can fully see and use the threads which bind the world together! Spell casting time and cooldowns are 25% faster now."),
