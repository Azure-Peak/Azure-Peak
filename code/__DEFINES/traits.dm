...
#define TRAIT_UNCONVERTABLE "Unconvertible"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_UNCONVERTABLE = span_info("My nature is inextricably tied to my patron. Any attempts at conversion will fail."),
