...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_GUARDSMAN = span_info("I am vigilant in my duties. In the town, my abilities are sharper due to my routine and familiarity."),
	...
	TRAIT_WOODSMAN = span_info("I am vigilant in my duties. In the wilderness, my abilities are sharper due to my routine and familiarity."),
