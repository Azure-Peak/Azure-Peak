...
#define TRAIT_VAMP_IMMUNE "Lycker Immunity"
#define TRAIT_WOLF_IMMUNE "Werevolf Immunity"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_VAMP_IMMUNE = span_info("My kind cannot bear the Sun curse for it already has another."),
	TRAIT_WOLF_IMMUNE = span_info("Dendor's madness shall find no hold in me."),
