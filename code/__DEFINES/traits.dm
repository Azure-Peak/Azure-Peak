...
#define TRAIT_VAMP_IMMUNE "Haemophilia Immunity"
#define TRAIT_WOLF_IMMUNE "Lycanthropy Immunity"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_VAMP_IMMUNE = span_info("Something within me overpowers any hold from the curse of Astrata's forsaken."),
	TRAIT_WOLF_IMMUNE = span_info("Something within me overpowers any hold from Dendor's curse of lycanthropy."),
