...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_PALLID = span_warning("I was once accursed by vampirism or lycantropy, making me better adapted to the night. My blood is repulsive for consumption, and I cannot be infected so easily anymore."),
