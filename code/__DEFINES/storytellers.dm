...
#define STORYTELLER_ANTAG_SOFT (1<<0)
#define STORYTELLER_ANTAG_VILLAIN (1<<1)
#define STORYTELLER_ANTAG_ROUNDSTART (1<<2)

#define STORYTELLER_FAVOR_NONE 0
#define STORYTELLER_FAVOR_BANDIT (1<<0)
#define STORYTELLER_FAVOR_GNOLL (1<<1)
#define STORYTELLER_FAVOR_ASSASSIN (1<<2)
#define STORYTELLER_FAVOR_LICH (1<<4)
#define STORYTELLER_FAVOR_WEREWOLF (1<<5)
#define STORYTELLER_FAVOR_VAMPIRE_LORD (1<<6)
#define STORYTELLER_FAVOR_DREAMWALKER (1<<7)
#define STORYTELLER_FAVOR_MASQUERADE (1<<8)
#define STORYTELLER_FAVOR_DARK_ITINERANT (1<<9)
#define STORYTELLER_ALL_ANTAGS (STORYTELLER_FAVOR_BANDIT | STORYTELLER_FAVOR_GNOLL | STORYTELLER_FAVOR_ASSASSIN | STORYTELLER_FAVOR_LICH | STORYTELLER_FAVOR_WEREWOLF | STORYTELLER_FAVOR_VAMPIRE_LORD | STORYTELLER_FAVOR_DREAMWALKER | STORYTELLER_FAVOR_MASQUERADE | STORYTELLER_FAVOR_DARK_ITINERANT)

#define STORYTELLER_STANDARD_FAVOR_MULTIPLIER 1.25
#define STORYTELLER_MAJOR_ANTAG_MIN_PLAYERS 40
#define STORYTELLER_MINOR_ANTAG_MIN_PLAYERS 15
