...
#define ARMOR_BLACKOAK list("blunt" = DR_ULTRA, "slash" = DBLOCK_MEDIUM, "stab" = DBLOCK_BSTEEL, "piercing" = DBLOCK_MEDIUM, "fire" = DR_NONE) // Wood: great vs blunt/stab, worse vs slash
