...
#define ARMOR_VAMP list("blunt" = DR_ULTRA, "slash" = DBLOCK_BSTEEL, "stab" = DBLOCK_HEAVY, "piercing" = DBLOCK_HEAVY, "fire" = DR_HEAVY, "acid" = DR_HEAVY) //Some of the most cracked armor in the game, exclusive to vlord.
