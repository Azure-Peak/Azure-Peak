...
/datum/economic_region
	...
	/// VALMORIA'S REGIONS section. The steward UI ignores it; only `description` shows there.
	var/subtitle = ""
	var/description = ""
...
/datum/economic_region/kingsfield
	...
	name = "Kingsfield"
	subtitle = "The Royal Demesne, Heartland of Valmoria"
	blockade_replenish_eligible = FALSE
	description = "The royal demesne of the Duke of Valmoria, and their most valuable possession besides Valmoria itself. A stretch of land some ten miles across the south bank of River Valmor, home to dozens of agricultural settlements, hamlets, and smaller market towns. Its lands are rich, and its people aplenty. The agricultural heartland of Valmoria, producing most of its grain, meat, and dairy, imported into Valmoria daily and re-exported for profit. Many of Valmoria's residents keep estates here. The Duke, owning most of the land directly, claims a tithe of ten percent of all produce from the region, and at least a quarter on any land directly owned by the Crown, as is their perogative, making this region vital to the Crown's coffers."
...
/datum/economic_region/daftsmarch
	...
	description = "The County of Daftsmarch is the heart of Valmoria's mining industry, a long strip of land hugging the southern end of Mount Decapitation. It produces most of the raw ore and salt that Valmoria depends on. The work pays well, and the veins are plentiful. But Daftsmarch sits uncomfortably close to the ruins of Tarichea, and the various denizens of the Underdark. The dangers posed by the drows and their ilk are a constant threat - many of them seeing Daftsmarch as a convenient source of slaves. But the ore vein are even richer - and the Crown is loathe to keep them unused - sending adventurers, mercenaries and garrison alike to do battle with the Underdark's denizens and keep them at bay."
...
/datum/economic_region/bleakcoast
	...
	description = "Also known as the Bleakisles Seamarch. A series of rocky outcrops said to have been created when Comet Syon impacted near the Terrorbog, radiating outward and hurling the islands from the sea itself. The archipelago numbers in the hundreds and makes navigation along all but a narrow stretch of Valmoria's coast treacherous. What it lacks in fertile land it makes up for in the bounty of its seas. Schools of fish swarm in the shallow, rocky bottoms and swim as far as Valmoria's coast, feeding thousands. But that bounty is not for Bleakisles inhabitants to enjoy. The isles are infested with pirates, the notorious Bleakisles Reavers, who prey on any merchant or fisherman that strays too far from shore. The Duchy maintains several garrisons to keep them in check, and has, once every two generations, undertaken a harrying of the isles, burning every non-military settlement and salting it. To no avail. Within a generation, the pirates always return, for trade is lucrative, and piracy even more so."
	threat_region_id = THREAT_REGION_VALMORIAN_COAST
	produces = list()
	demands = list(
...
/datum/economic_region/northfort
	...
	description = "A fortified castle at the northern approach into Valmoria, the only direct overland route from the north. As economically unproductive as a fort can be, which is very. The crown feeds it because without it, the border between Grenzelhoft and Valmoria becomes negotiable."
...
/datum/economic_region/heartfelt
	...
	name = "Heartfelt"
	subtitle = "The Borderland, Greatest Vassal of Valmoria"
	description = "The County of Heartfelt is Valmoria's most powerful vassal, comprising nearly the entirety of the western borderland, bordering Otava, Grenzelhoft, Naledi, and Aavnr. The Count of Heartfelt has always been afforded considerable liberty in how they raise revenues and how many men they keep under arms, for if Heartfelt falls, Valmoria's heartland would be exposed. Its defense is funded by a network of estates, holdings, and acres scattered across hundreds of pockets in Valmoria outside Heartfelt proper, which the Count uses to purchase armaments and pay retinue alike. But any ruler of Valmoria knows there is no greater threat to themselves than the self-professed greatest defender of Valmoria."
	threat_region_id = THREAT_REGION_AZURE_GROVE
	produces = list()
	demands = list(
		TRADE_GOOD_STEEL_INGOT = TG_DEMAND_REFINED_INGOTS,
...
/datum/economic_region/hagenwald
	...
	description = "The industrial heart of Valmoria, sitting on the northern face of Mount Decapitation, where Daftsmarch's ore is taken by mules to be smelted, refined, and forged. Hagenwald produces nearly every ingot of iron, steel, copper, and tin the kingdom uses - without its furnaces, Valmoria's smiths would be reduced to working scrap. The town's wealth is built on coppiced woodland that flanks it on three sides, cut and re-cut on a generational rotation so the fire never go out. Its workforce is half Grenzelhoftian by descent, drawn over the centuries by wages, and the streets are perpetually grey with soot. The Crown garrisons it quietly."
	threat_region_id = THREAT_REGION_MOUNT_DECAP
	produces = list(
