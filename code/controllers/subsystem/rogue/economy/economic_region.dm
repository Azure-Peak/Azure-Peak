...
/datum/economic_region/hagenwald
	...
	name = "Hagenwald"
	description = "Located on the other side of Mount Decapitation, next to abundant, coppiced woodland that provides for its many forges. Hagenwald is the industrial heart of Azuria."
	threat_region_id = THREAT_REGION_MOUNT_DECAP
	produces = list(
