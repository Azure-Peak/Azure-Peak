...
/proc/get_navigator_bucket_for_category(category)
	switch(category)
		...
		if(ITEM_CAT_GARMENT_COMMON)
			return NAVIGATOR_BUCKET_GARMENT_COMMON
		if(ITEM_CAT_GARMENT_FINE, ITEM_CAT_GARMENT_LUXURY)
...
/proc/get_navigator_bucket_for_item(obj/item/I, category)
	if(I?.is_carved)
...
/proc/get_navigator_bucket_theme(bucket)
	switch(bucket)
		...
		if(NAVIGATOR_BUCKET_SEAFOOD, NAVIGATOR_BUCKET_BEVERAGE)
			return MARKET_THEME_FOODSTUFFS
		if(NAVIGATOR_BUCKET_VALUABLES_CRAFTED, NAVIGATOR_BUCKET_VALUABLES_LOOTED, NAVIGATOR_BUCKET_CARVED, NAVIGATOR_BUCKET_POTTERY, NAVIGATOR_BUCKET_TROPHIES, NAVIGATOR_BUCKET_INSTRUMENTS, NAVIGATOR_BUCKET_BOOKS)
			return MARKET_THEME_LOOT
		if(NAVIGATOR_BUCKET_ENGINEERING)
			return MARKET_THEME_ENGINEERING
	return MARKET_THEME_MISC
