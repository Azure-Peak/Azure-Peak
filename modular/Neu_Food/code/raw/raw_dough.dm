...
/obj/item/reagent_containers/food/snacks/rogue/butterdough/attackby(obj/item/I, mob/living/user, params)
	...
	// (jackberry + poison stay hardcoded below: poison is a SUBTYPE of jackberry, which an istype matcher
	//  would mis-route -- needs a most-specific-match matcher before they can migrate.)
