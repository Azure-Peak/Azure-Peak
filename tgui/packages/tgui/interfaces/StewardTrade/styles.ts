...
export const pageStyle: CSSProperties = {
  ...
  lineHeight: 1.5,
  background: `
    radial-gradient(circle at 20% 10%, ${PARCHMENT} 0%, ${PARCHMENT_DEEP} 65%, ${PARCHMENT_SHADOW} 100%),
    ${PARCHMENT}
  `,
  boxShadow:
    'inset 0 0 140px rgba(120,80,30,0.22), inset 0 0 40px rgba(60,40,10,0.18)',
};
